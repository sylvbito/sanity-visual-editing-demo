...
export default function PageBuilder({page}: PageBuilderPageProps) {
  const pageBuilderSections = useOptimistic<PageBuilderSection[], SanityDocument<PageData>>(
    page?.pageBuilder || [],
    (currentSections, action) => {
      // Sanity's mutation actor supplies the fully-rebased document. Render its
      // pageBuilder verbatim; attempting to reconcile it with old sections was
      // swallowing the new values and made the canvas lag until refresh.
